      ...
      <div class="container">
        <div class="row align-items-center min-vh-75 min-vh-md-50">
          <div class="col-12 text-center py-8">
            <h1 class="lh-sm fs-lg-6 fs-xxl-7"><?= $nama_kategori; ?></h1>
          </div>
        </div>
      </div>
    </section>
                ...
                <div class="row g-0 flex-center">
                  ...
                  <div class="col-md-7 col-lg-8">
                    <div class="card-body ps-5 p-lg-8">
                      ...
                      <p class="card-text mb-4 fs-1 pe-xxl-8"></p>
                      <div class="d-flex flex-row"><a class="btn px-0 me-3 text-primary" href="<?= base_url('home/artikel/' . $uu['slug']) ?>">Baca Selengkapnya</a></div>
                    </div>
                  </div>
                </div>
              </div>
