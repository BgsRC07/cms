...
<head>
  ...
  <link href="<?= site_url('assets/sbadmin/')?>css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url(); ?>">
        ...
        <div class="sidebar-brand-text mx-3"><?= $judul_halaman ?></div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?= base_url('assets/img/th.jpg'); ?>">
              </a>
  ...
  <script src="<?= site_url('assets/sbadmin/') ?>vendor/jquery/jquery.min.js"></script>
  <script src="<?= site_url('assets/sbadmin/') ?>vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script src="<?= site_url('assets/sbadmin/') ?>vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="<?= site_url('assets/sbadmin/') ?>js/sb-admin-2.min.js"></script>

  <!-- Page level plugins -->
  <script src="<?= site_url('assets/sbadmin/') ?>vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?= site_url('assets/sbadmin/') ?>js/demo/chart-area-demo.js"></script>
  <script src="<?= site_url('assets/sbadmin/') ?>js/demo/chart-pie-demo.js"></script>
